...
class Ui_widget(object):
    def setupUi(self, widget):
        ...
        self.pushButton_6.setGeometry(QtCore.QRect(10, 70, 160, 40))
        ...
        self.pushButton_7.setGeometry(QtCore.QRect(20, 280, 160, 40))
        self.pushButton_7.setObjectName("pushButton_7")
        self.pushButton_8 = QtWidgets.QPushButton(self.groupBox_2)
        self.pushButton_8.setGeometry(QtCore.QRect(20, 340, 160, 40))
        ...
        self.pushButton_9.setGeometry(QtCore.QRect(10, 180, 180, 40))
        self.pushButton_9.setObjectName("pushButton_9")
        self.pushButton_10 = QtWidgets.QPushButton(self.groupBox_4)
        self.pushButton_10.setGeometry(QtCore.QRect(10, 280, 180, 40))
        ...
        self.pushButton_11.setGeometry(QtCore.QRect(10, 180, 180, 40))
    ...
    def retranslateUi(self, widget):
        ...
        self.pushButton_6.setText(_translate("widget", "1.3 Find Extrinsic"))
        ...
        self.pushButton_7.setText(_translate("widget", "1.4 Find Distortion"))
        self.pushButton_8.setText(_translate("widget", "1.5 Show Result"))
        self.groupBox_4.setTitle(_translate("widget", "2. Augmented Reality"))
        self.pushButton_9.setText(_translate("widget", "2.1 Show Words on Board"))
        self.pushButton_10.setText(_translate("widget", "2.2 Show Words Vertically"))
        self.groupBox_5.setTitle(_translate("widget", "3. Stereo Disparity Map"))
        self.pushButton_11.setText(_translate("widget", "3.1 Stereo Disparity Map"))
